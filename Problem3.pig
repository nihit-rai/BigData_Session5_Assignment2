...
Lookup = load 'airports.csv' USING org.apache.pig.piggybank.storage.CSVExcelStorage(',','NO_MULTILINE','UNIX','SKIP_INPUT_HEADER');
...
STORE Final_Result into 'Problem3' using PigStorage(',');